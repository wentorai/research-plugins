...
| 类别 | 技能数 | 覆盖范围 |
|:--|:--|:--|
| **文献** (literature) | 80 | 多库联搜 · 引文追踪 · 全文获取 · 开放获取 |
| **研究方法** (research) | 52 | DID · RDD · IV · 元分析 · 系统综述 · 基金申请 |
| **数据分析** (analysis) | 44 | Python · R · STATA · 可视化 · 面板数据 · 计量经济 |
| **学术写作** (writing) | 62 | 论文各章节 · LaTeX · 参考文献 · 审稿意见回复 |
| **学科领域** (domains) | 147 | 16 个学科：CS · AI/ML · 生物医学 · 经济 · 法学 · 物理 等 |
| **效率工具** (tools) | 48 | 流程图 · PDF 解析 · 知识图谱 · OCR · 爬虫 |

技能通过 **渐进式加载** 机制工作：6 个类别入口 → 40 个子分类索引 → 433 个具体技能。Agent 按需加载，不会一次性注入全部内容。
