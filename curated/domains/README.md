...
| [domain-adaptation-papers-guide](../../skills/domains/ai-ml/domain-adaptation-papers-guide/) | Comprehensive collection of domain adaptation research papers |
...
| [graph-learning-papers-guide](../../skills/domains/ai-ml/graph-learning-papers-guide/) | Conference papers on graph neural networks and graph learning |
...
| [kolmogorov-arnold-networks-guide](../../skills/domains/ai-ml/kolmogorov-arnold-networks-guide/) | Papers and tutorials on KAN learnable activation networks |
...
| [npcpy-research-guide](../../skills/domains/ai-ml/npcpy-research-guide/) | All-in-one Python library for NLP, agents, and knowledge graphs |
...
| [responsible-ai-guide](../../skills/domains/ai-ml/responsible-ai-guide/) | Resources for trustworthy, fair, and ethical AI research |
...
| [vmas-simulator-guide](../../skills/domains/ai-ml/vmas-simulator-guide/) | Vectorized multi-agent reinforcement learning simulator |
...
| [clawbio-guide](../../skills/domains/biomedical/clawbio-guide/) | OpenClaw bioinformatics skill library for genomics pipelines |
| [clinical-dialogue-agents-guide](../../skills/domains/biomedical/clinical-dialogue-agents-guide/) | Papers on AI agents for clinical dialogue and medical QA |
...
| [ena-sequence-api](../../skills/domains/biomedical/ena-sequence-api/) | Access nucleotide sequence data from the European Nucleotide Archive |
...
| [genomas-guide](../../skills/domains/biomedical/genomas-guide/) | Automate gene expression analysis with the GenoMAS multi-agent system |
...
| [genotex-benchmark-guide](../../skills/domains/biomedical/genotex-benchmark-guide/) | Benchmark for LLM agents on gene expression data analysis |
| [med-researcher-guide](../../skills/domains/biomedical/med-researcher-guide/) | Multi-agent system for biomedical literature review and synthesis |
| [med-researcher-r1-guide](../../skills/domains/biomedical/med-researcher-r1-guide/) | Medical deep research agent with reasoning chain analysis |
...
| [ncbi-blast-api](../../skills/domains/biomedical/ncbi-blast-api/) | Run sequence similarity searches via the NCBI BLAST REST API |
| [ncbi-datasets-api](../../skills/domains/biomedical/ncbi-datasets-api/) | Access genomes, genes, and taxonomy data via NCBI Datasets v2 API |
| [quickgo-api](../../skills/domains/biomedical/quickgo-api/) | Browse and search Gene Ontology annotations via the QuickGO API |
...
| Skill | Description |
|-------|-------------|
| [cactus-cheminformatics-guide](../../skills/domains/chemistry/cactus-cheminformatics-guide/) | PNNL cheminformatics LLM agent for molecular analysis |
| [chemeagle-guide](../../skills/domains/chemistry/chemeagle-guide/) | Multi-agent system for chemical literature information extraction |
| [chemgraph-agent-guide](../../skills/domains/chemistry/chemgraph-agent-guide/) | Automate molecular simulations with the ChemGraph agentic framework |
...
| Skill | Description |
|-------|-------------|
| [ai-security-papers-guide](../../skills/domains/cs/ai-security-papers-guide/) | AI security papers from top-4 security conferences |
...
| [code-llm-papers-guide](../../skills/domains/cs/code-llm-papers-guide/) | Survey and paper collection on LLMs for code generation |
...
| [gaussian-splatting-papers-guide](../../skills/domains/cs/gaussian-splatting-papers-guide/) | Curated papers and resources for 3D Gaussian Splatting |
| [llm-aiops-guide](../../skills/domains/cs/llm-aiops-guide/) | Papers on LLMs for IT operations and AIOps research |
...
| [software-heritage-api](../../skills/domains/cs/software-heritage-api/) | Archive and retrieve source code history via Software Heritage API |
...
| [nber-working-papers-api](../../skills/domains/economics/nber-working-papers-api/) | Access NBER working papers and economic research datasets |
...
| [repec-economics-api](../../skills/domains/economics/repec-economics-api/) | Access 4M+ economics working papers and articles via RePEc API |
...
| Skill | Description |
|-------|-------------|
| [academic-study-methods](../../skills/domains/education/academic-study-methods/) | Evidence-based study techniques for academic learning and retention |
...
| Skill | Description |
|-------|-------------|
| [akshare-finance-data](../../skills/domains/finance/akshare-finance-data/) | Access Chinese and global financial data using the AkShare Python library |
...
| [finsight-research-guide](../../skills/domains/finance/finsight-research-guide/) | Deep financial research with the FinSight multi-agent system |
| [options-analytics-agent-guide](../../skills/domains/finance/options-analytics-agent-guide/) | AI agent for options pricing, Greeks, and strategy analysis |
...
| [pangaea-data-api](../../skills/domains/geoscience/pangaea-data-api/) | Access earth and environmental science datasets via PANGAEA API |
...
| Skill | Description |
|-------|-------------|
| [caselaw-access-api](../../skills/domains/law/caselaw-access-api/) | Query 360+ years of US case law via the Harvard Caselaw Access Project |
...
| Skill | Description |
|-------|-------------|
| [lean-theorem-proving-guide](../../skills/domains/math/lean-theorem-proving-guide/) | LLM agent for formal theorem proving in Lean 4 |
...
| [madd-drug-discovery-guide](../../skills/domains/pharma/madd-drug-discovery-guide/) | Multi-agent system for automated drug discovery pipelines |
...
| Skill | Description |
|-------|-------------|
| [ipums-microdata-api](../../skills/domains/social-science/ipums-microdata-api/) | Access harmonized census and survey microdata via the IPUMS API |
